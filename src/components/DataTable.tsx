        ...
        <Box sx={{ height: '100%', width: '100%' }}>
            <StyledDataGrid
                ...
                columns={[
                    ...
                    { field: '2021', minWidth: 50, flex: 0.4, align: 'right', headerAlign: 'right', disableColumnMenu: true, },
                    { field: '2020', minWidth: 50, flex: 0.4, align: 'right', headerAlign: 'right', disableColumnMenu: true, },
                    { field: '2019', minWidth: 50, flex: 0.4, align: 'right', headerAlign: 'right', disableColumnMenu: true, },
                    { field: '2015', minWidth: 50, flex: 0.4, align: 'right', headerAlign: 'right', disableColumnMenu: true, },
                    { field: '2010', minWidth: 50, flex: 0.4, align: 'right', headerAlign: 'right', disableColumnMenu: true, },
                    { field: '2000', minWidth: 50, flex: 0.4, align: 'right', headerAlign: 'right', disableColumnMenu: true, }
                ]}
